...
G.CFG = {
  ...
  splitLaunchRadii: 3.0,     // large cells launch about this many own radii forward
  splitImpulseMax: 6500,    // cap radius-scaled split speed
  splitStartSeparation: 1.55, // immediate center distance in radii after splitting
  splitBackPush: 0.25,       // how much the old half is pushed backward on split
