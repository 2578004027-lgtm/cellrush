...
G.CFG = {
  ...
  // split (Space)
  splitMin: 35,
  splitImpulse: 660,         // minimum launch speed of the new piece (world u/s)
  splitLaunchRadii: 0.96,    // velocity chosen so large pieces glide about this many radii
  splitImpulseMax: 2100,     // cap radius-scaled split speed
  splitStartSeparation: 1.72, // front half starts close, then launches (Agar-like)
  splitBackPush: 0.18,       // slight recoil keeps one-cell splits from visually sticking
  ...
  skills: {
    ...
    thorn:   { key: '3', name: '\u5410\u523a',   cd: 10, dur: 0.0,  speed: 1060, mass: 130, loss: 35, color: '#76ff45', cost: 150, special: true },
...
G.settings = { sound: true, names: true, minimap: true, admin: false, visualSkins: false, visualStatus: false, visualFx: false, visualAllNames: false, visualSqueeze: true, cursorLine: true, enemyHint: true, massMarker: true, gameStats: true, perfStats: true, playerStatus: true, splitPreview: true, autosplitAlert: true, deathMenu: false, showChat: true, signalMarker: true, edgeIndicators: true, mapTheme: 'classic' };
